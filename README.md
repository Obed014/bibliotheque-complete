    ...
    <main className="main">
      ...
      {tab==='dashboard'&&(
        <div>
          ...
          {overdue.length>0&&<div className="al al-w au2"><Icon name="alert" size={14}/><strong>{overdue.length} prêt(s) en retard</strong></div>}
      ...
      {tab==='books'&&(
        <div>
          <div className="ph au">
            ...
            <div style={{display:'flex',gap:8}}>
              <button className="btn btn-secondary" onClick={()=>{setZp([]);setZst('');setModal('zotero');}}><Icon name="download" size={13}/>Zotero</button>
